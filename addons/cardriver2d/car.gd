...
class_name CarDriver2D   # #235 renamed from "Car" — collided with the plant's 3D vehicle Car (src/scenes/vehicles/cars/Car.gd), breaking every NPC-car subclass. This 2D demo addon is unused by CeDo.
