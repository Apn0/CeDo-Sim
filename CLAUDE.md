...
| `docs/plant/operator_rulings_2026-09-25.md` | **Extruder start, rpm setpoint, green button, 2026-09-25**: a start ramps to the setpoint the operator left (not always to 60), 60 is the floor and the remedy after a 318 trip, a new extruder starts at 60, green waits out the lumps, 3 s to 60 kept against the archive's ~5 s, a line choice on the HMI. Recollections beside the raw WinCC archive's 126 starts (60 after long stops, the old rpm after short ones). Open: start interlocks, the left "easy work" button |
...
ruling, `docs/plant/operator_rulings_2026-09-25.md` §3.

**How a start runs (operator rulings 2026-09-25, same file §1-§5).** A start
