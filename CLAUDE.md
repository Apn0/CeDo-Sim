...
- **`rebuild()` rebuilds the edges from scratch; whatever lives ON an edge is
  ...
  rebuild with `_survivor_key()`. `docs/audit/rebuild_pipe_carry_2026-09-25.md`.
